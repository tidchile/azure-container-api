...
var getProviderName = function (resourceType) {
...
var getResourceTypeName = function (resourceType) {
...
var createClusterPayloadLinux = function createClusterPayloadLinux(clusterName, storageAccountName, storageAccountKey, storageContainer, dataNodeCount, headNodeSize, dataNodeSize, location, userName, password, sshUserName, sshPassword, subscriptionId) {
    ...
    clusterPayload += ' },';
    clusterPayload += ' "hardwareProfile": {';
    clusterPayload += ' "vmSize": "' + headNodeSize + '"';
    clusterPayload += ' },';
    clusterPayload += ' "storageProfile": {';
    clusterPayload += ' "osDisk": {';
    clusterPayload += ' "name": "Disk1",';
    ...
    clusterPayload += ' },';
    clusterPayload += ' "hardwareProfile": {';
    clusterPayload += ' "vmSize": "' + dataNodeSize + '"';
    clusterPayload += ' },';
    clusterPayload += ' "storageProfile": {';
    clusterPayload += ' "osDisk": {';
    clusterPayload += ' "name": "Disk1",';
