...
var createResourceGroup = function(credential, options) {
    return new Promise(function(resolve, reject) {
        var mgmClt = resourceManagement.createResourceManagementClient(credential);
        mgmClt.resourceGroups.createOrUpdate(options.resourceGroupName, options, 
            function(err, result) {
...
var checkExistenceResourceGroup = function(credential, resourceGroupName) {
    return new Promise(function(resolve, reject) {
        var mgmClt = resourceManagement.createResourceManagementClient(credential);
        mgmClt.resourceGroups.checkExistence(resourceGroupName, 
            function(err, result) {
                err ? reject(err) : resolve(result); 
        });
    });
...
module.exports = {
    ...
    ,checkExistenceResourceGroup:checkExistenceResourceGroup
};
